        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 space-y-3 bg-white rounded shadow">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <label htmlFor="funcionalidades" className="text-sm font-medium">Funcionalidades Esperadas</label>
                        <textarea
                            id="funcionalidades"
                    ...
                    <button type="submit" className="w-full p-2 text-white bg-blue-500 rounded hover:bg-blue-600">Inscrever-se</button>
                </form>
            </div>
        </div>
    );
